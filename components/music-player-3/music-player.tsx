...
export function MusicPlayer({
  ...
  return (
    <div
      className={cn(
        "relative select-none text-neutral-900 transition-[width] duration-700 ease-out dark:text-white",
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 -top-3 z-20 flex h-9 w-9 items-center justify-center rounded-full border border-neutral-200/90 bg-white shadow-sm shadow-neutral-950/10 backdrop-blur-md transition-transform hover:scale-105 hover:bg-neutral-50 active:scale-95 dark:border-white/20 dark:bg-white/15 dark:shadow-none dark:hover:bg-white/20"
      >
      ...
      {artwork ? (
        ...
        <img
          ...
          className="absolute -top-5 left-0 z-20 h-20 w-20 rounded-xl object-cover shadow-lg shadow-neutral-950/15 ring-1 ring-neutral-200/90 dark:shadow-black/30 dark:ring-white/20"
        />
      ) : null}

      {/* Player bar */}
      <div className="relative flex h-[70px] items-center gap-3 overflow-hidden rounded-xl border border-neutral-200/90 bg-white/95 pl-24 pr-5 shadow-md shadow-neutral-950/10 backdrop-blur-md dark:border-white/15 dark:bg-white/15 dark:shadow-none">
        {/* Equalizer */}
        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-1">
            <button
              ...
              className="rounded-full p-1.5 opacity-80 transition hover:bg-neutral-100 hover:opacity-100 dark:hover:bg-white/10"
            >
            ...
            <button
              ...
              className="rounded-full p-1.5 opacity-90 transition hover:bg-neutral-100 hover:opacity-100 dark:hover:bg-white/10"
            >
              {isPlaying ? (
        ...
        {showProgress && !collapsed ? (
          ...
          >
            <div className="relative h-[3px] w-full bg-neutral-200 dark:bg-white/15">
              <div
