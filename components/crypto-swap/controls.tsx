...
import { SPRING_PRESS } from "../shared/ease";
  ...
  return (
    <div className="relative -my-4 flex justify-center" style={{ zIndex: 1 }}>
      <motion.button
        ...
        className="inline-flex h-9 w-9 items-center justify-center rounded-full border-[3px] border-white bg-zinc-100 text-foreground shadow-md shadow-zinc-300/60 backdrop-blur dark:border-card dark:bg-primary/10 dark:shadow-none"
      >
...
export function DestinationRow({
  ...
  return (
    <div className="mt-1 overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50/70 shadow-[0_2px_8px_rgba(15,23,42,0.04)] dark:border-border/50 dark:bg-background/40 dark:shadow-none">
      <button
        type="button"
        onClick={onToggle}
      ...
      <AnimatePresence>
        {show ? (
          ...
          >
            <div className="border-t border-zinc-200 px-3.5 pb-3 pt-2.5 dark:border-border/50">
              <div
                className={cn(
